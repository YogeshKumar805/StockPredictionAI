    ...
    st.markdown("""
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            toggle.addEventListener('click', function() {
                ...
                toggle.innerHTML = footer.classList.contains('footer-hidden') ? '↑' : '↓';
            });
        });
        </script>
    ...
    st.markdown("""
        <div class="footer">
            <div class="footer-content">
                <div>Made with ❤️ by Yogesh Kumar</div>
                <div class="social-links">
                    <a href="https://www.linkedin.com/in/yogesh-kumar-911ba0252/" target="_blank" class="social-link">
                    ...
                    <a href="https://github.com/yogeshkumar805" target="_blank" class="social-link">
